...
class RigidBody(metaclass=Metaclass_RigidBody):
    ...
    def __init__(self, **kwargs):
        ...
        self.tracking_lost = kwargs.get('tracking_lost', bool())
        self.model_filled = kwargs.get('model_filled', bool())
    ...
    def __eq__(self, other):
        ...
        if self.mean_error != other.mean_error:
            return False
        if self.tracking_lost != other.tracking_lost:
            return False
        if self.model_filled != other.model_filled:
            return False
        return True
    ...
    def tracking_lost(self):
        """Message field 'tracking_lost'."""
        return self._tracking_lost

    @tracking_lost.setter
    def tracking_lost(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'tracking_lost' field must be of type 'bool'"
        self._tracking_lost = value

    @builtins.property
    def model_filled(self):
        """Message field 'model_filled'."""
        return self._model_filled

    @model_filled.setter
    def model_filled(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'model_filled' field must be of type 'bool'"
        self._model_filled = value
