...
class Description(metaclass=Metaclass_Description):
    ...
    def __init__(self, **kwargs):
        ...
        self.num_markers = kwargs.get('num_markers', int())
    ...
    def num_markers(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'num_markers' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'num_markers' field must be an integer in [-2147483648, 2147483647]"
