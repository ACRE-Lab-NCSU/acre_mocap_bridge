...
bool wyrm_msgs__msg__rigid_body__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wyrm_msgs.msg._rigid_body.RigidBody", full_classname_dest, 35) == 0);
  }
  wyrm_msgs__msg__RigidBody * ros_message = _ros_message;
  {  // id
  ...
  {  // tracking_lost
    PyObject * field = PyObject_GetAttrString(_pymsg, "tracking_lost");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->tracking_lost = (Py_True == field);
    Py_DECREF(field);
  }
  {  // model_filled
    PyObject * field = PyObject_GetAttrString(_pymsg, "model_filled");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->model_filled = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * wyrm_msgs__msg__rigid_body__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("wyrm_msgs.msg._rigid_body");
  ...
  {  // tracking_lost
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->tracking_lost ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tracking_lost", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // model_filled
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->model_filled ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "model_filled", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
